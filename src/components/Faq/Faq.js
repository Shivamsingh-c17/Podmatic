...
export default function Faq() {
	var generalQuestions = [
		...
		},
		{
			...
			question: "Who is behind Podmatic?",
			answer: "Check out the team page!",
		},
		{
			ID: "heading5",
			dataBsTarget: "collapse5",
			question: "Is this a platform like Spotify, just on blockchain? Or is it just a platform where users can trade individual podcasts?",
			answer: "Currently, Podmatic is a platform to trade individual NFTs of podcasts. NFTs from podcasters can be looked at as stocks in the market. Just as buying stocks of companies that people believe to perform good in the future can result in massive profits, similarly, the value of these NFTs can skyrocket if that artist grows to be successful over time.",
		},
	];
	...
	var needQuestions = [
		{
			...
			answer: `<span class="orange_subhead">Can I play on a mobile device?</span>
					<br/>
					You sure can! We currently support the Metamask wallet, and plan to integrate with other wallets like the Coinbase Wallet and Trust Wallet in the future. Plus, we will be building a mobile app for Podmatic, so you’ll soon be able to play anywhere!
					<br/>
					<br/>
					<span class="orange_subhead">Can I log in from multiple computers?</span>
					<br/>
					You can use Podmatic from multiple computers as long as you have your digital wallet installed on both.
			`,
		},
		{
			ID: "heading7",
			...
			answer: `<span class="orange_subhead">Installing your digital wallet</span>
					<br/>
					<ul>
						<li>To use Podmatic, you need a digital wallet. We only support the Metamask wallet currently.</li>
					...
					<span class="orange_subhead">What is a “wallet address”?</span>
					<br/>
		...
		},
		{
			...
			answer: `<span class="orange_subhead">What is MATIC? Why do I need it?</span>
					<br/>
					<ul>
						<li>MATIC is a digital currency that powers the Polygon network, which is what Podmatic is built on. MATIC acts like any other currency— its value fluctuates with the market.</li>
						<li>You need to convert your currency (e.g. USD, INR, CAD, GBP) into MATIC to trade NFTs on Podmatic.</li>
					</ul>
			`,
		},
	];

	var aboutPodMaticQuestions = [
		{
			ID: "heading9",
			dataBsTarget: "collapse9",
			question: "Are Podmatic NFTs like Bitcoin?",
			answer: `<ul>
						<li>NFTs on Podmatic are NOT a cryptocurrency. They’re a cryptocollectibles. The real-world analogy for a cryptocurrency is dollars or rupees; a cryptocollectible’s real world analogy is closer to assets like baseball cards or fine art.</li>
		...
		},
		{
			...
			question: "Are Podmatic NFTs ERC-721 tokens?",
			answer: `This is quite ambiguous. We comply with the ERC-721 standard but Podmatic is a custom contract, which means that it doesn't comply completely with any standards.`,
		},
		{
			ID: "heading11",
			dataBsTarget: "collapse11",
			question: "Where are the podcasts and cover images for the Podmatic NFTs stored?",
			answer: `The actual podcasts and images of the NFTs are too large to store on the blockchain, so we store the podcasts and images on IPFS, and then embed the hashes into our smart contract.`,
		},
		{
			ID: "heading12",
		...
		},
		{
			...
			answer: `Yes, the creator will receive a royalty of 5% everytime the NFT is sold.`,
		},
		{
			ID: "heading14",
			dataBsTarget: "collapse14",
			question: "What is the breakdown of a transaction?",
			answer: `After the creation of an NFT, if a buyer wishes to buy it, the podcaster(creator) will receive 99% of the transaction amount and 1% will be contributed towards the platform fee. On subsequent transactions, the creator will receive 5% as royalty, the previous owner will receive 94% of the transaction amount, and a meagre 1% will be contributed towards the platform fee.`,
		},
		{
			ID: "heading15",
			dataBsTarget: "collapse15",
			question: "Links to which platforms can be included by the podcaster?",
			answer: `Currently, we provide support for Spotify, Audible, Apple Podcast, and Google Podcast.`,
		},
		{
			ID: "heading015",
			dataBsTarget: "collapse015",
			question: "Why do we take gas fee from users?",
			answer: `It is required by the blockchain to pay a small amount for performing transactions. We could have created the smart contract in a way so that the gas fee would be deducted from our account, but we didn't do it to reduce spammers, so that only genuine podcasters upload their podcasts to create NFTs.`,
		},
		{
			ID: "heading16",
			dataBsTarget: "collapse16",
			question:
				"Why would a budding artist want to sell a NFT to a single person when their main objective is to create an audience by giving the podcast out for free for the world to listen to?",
			answer: `The artist will still be able to do that. It is true that the main objective of an artist is to expand their audience but they still require monetary support along the way. We, at Podmatic, enable podcasters to get this support.`,
		},
	];
	...
	var buyingAndSellingQuestions = [
		{
			...
			question: "How do I get an NFT on Podmatic?",
			answer: `Buy one from the Marketplace, which you can look through using the Library page. Click on one card and then purchase from the Podcast Info page.`,
		},
		{
			ID: "heading18",
			dataBsTarget: "collapse18",
			question: "How can a buyer resell the NFT?",
			answer: `A buyer can put the NFT on the Podmatic marketplace and any interested buyer can purchase the NFT for the specified price.`,
		},
		{
			ID: "heading19",
		...
		},
		{
			...
			answer: `You can go to the Podcast Info page and put up the NFT on sale. If any buyer is interested in purchasing the NFT for the price that you have specified, then they can just buy it from you and it will be sold.`,
		},
		{
			ID: "heading21",
			dataBsTarget: "collapse21",
			question: "I sold a podcast NFT. Where’s my MATIC?",
		...
		},
		{
			...
			answer: `
				<ul>
					...
					<li>Our smart contracts secure each NFT on Podmatic so that the developers can’t edit, access, or reassign them. This protects your NFTs from hackers and anyone else who would steal them. Unfortunately, it also means we can’t simply ‘recover’ an NFT on Podmatic.</li>
				</ul>
			`,
		},
		{
			...
			answer: `After the creation of an NFT, if a buyer wishes to buy it, the podcaster will receive 99% of the transaction amount and 1% will be contributed towards the platform fee. On subsequent transactions, the creator will receive 5% as royalty, the previous owner will receive 94% of the transaction amount, and a meagre 1% will be contributed towards the platform fee. Finally, you will become the owner of the NFT!`,
		},
		{
			ID: "heading25",
			dataBsTarget: "collapse25",
			question: "Would the creator of the podcast have any distribution rights after the trade has occurred and they have sold it to someone else?",
			answer: `Yes, the distribution rights will remain with the artist and they will have full control over the podcast.`,
		},
		{
			ID: "heading26",
			dataBsTarget: "collapse26",
			question: "What are the rights of a buyer after buying the NFT?",
			answer: `The buyer can use the podcast anywhere they want, but not for monetary benefits. The buyer just owns a copy of the podcast (i.e. the NFT), not the podcast itself.`,
		},
	];
	...
	var transactionsAndTechnicalQuestions = [
		...
		},
		{
			...
			answer: `
				<ul>
					<li>‘Gas’ is a shorthand used to describe the cost of powering a transaction or contract in Polygon, which is the blockchain network that Podmatic is built on.</li>
					<li>Because blockchain is decentralized, every transaction is distributed through multiple computers, not a central server. This ensures each token — in this case, each NFT on Podmatic — is secure and one-of-a-kind. It also takes a lot of computational power, which is covered by the cost of gas.</li>
		...
		},
		{
			...
			question: "What should be the file size to be uploaded?",
			answer: `The file size should remain below a 100MB limit.`,
		},
		{
			ID: "heading31",
			dataBsTarget: "collapse31",
			question: "Help! My problem wasn’t addressed here. How do I contact the Podmatic team?",
			answer: `
				<ul>
					<li>You can contact us at <span class="orange_subhead">contact@Podmatic.com</span>. Please include any relevant NFT IDs, links, or transaction hashes so we can support you as quickly as possible.</li>
	...
	var communityQuestions = [
		{
			...
			answer: `We have an official Podmatic Discord group as well as a Twitter account. Check out by clicking the icons in the website footer.`,
		},
		{
			ID: "heading33",
		...
		},
		{
			...
			question: "How do I contact the Podmatic team?",
			answer: `You can contact us at <span class="orange_subhead">contact@Podmatic.com</span>. Please include any relevant NFT IDs, links, or transaction hashes so we can support you as quickly as possible.`,
		},
	];
			...
			<div className="faq_container">
				<div className="faq_box">
					...
					<div className="d-flex flex-column flex-md-row align-items-start width100 m-0 p-0">
						<div
							className="nav flex-column nav-pills me-3 faq_nav_link_box glass_effect glass_effect_border"
							id="v-pills-tab"
							role="tablist"
						...
						<div className="tab-content mt-md-0 mt-5 width100" id="v-pills-tabContent">
											...
											<div className="accordion-item">
												...
												>
													<div className="accordion-body">
														Podmatic is a decentralized application(dApp) for podcasters to create NFTs of their podcasts. These NFTs
														can then be traded and each time an NFT gets traded, the podcaster will get 5% of the trade as royalty!
													</div>
												</div>
											</div>
							...
							<div className="tab-pane fade" id="v-pills-about" role="tabpanel" aria-labelledby="v-pills-about-tab">
								<div className="faq_card glass_effect glass_effect_border">
									<div className="row faq_section_heading">About Podmatic</div>

									<div className="accordion_container">
										<div className="offset-1 col-10 accordion" id="accordionFlush3">
											{aboutPodMaticQuestions.map((item, key) => {
												return (
													<div className="accordion-item" key={key}>
														<h2 className="accordion-header row" id={item.ID}>
															<button
