...
import PodcastDesc from "./PodcastDesc/PodcastDesc";
...
export default function PodcastInfo(props) {
	...
	const _podcast = props.podcastNFTs[parseInt(prop.podcastId) - 1];
	...
	return (
		<Fragment>
			<div className="podcast_info_container">
				<div className="podcast_info_box">
					<div className="row justify-content-center m-sm-4 m-3 ml-md-5 ml-0">
						<div className="col-lg-3 col-md-5 col-sm-8 col-12 order-lg-1 order-md-1 order-sm-1">
							<CoverCard
								podcast={_podcast}
								podcastCoverURL={`https://podmatic.infura-ipfs.io/ipfs/${_podcast.hashes.imgHash}`}
								amount={web3.utils.fromWei(_podcast.price.toString(), "Ether")}
								purchasePodcast={props.purchasePodcast}
						...
						<div className="col-lg-6 col-md-7 pl-lg-5 pl-md-4 pt-2 order-lg-2 mt-md-0 order-md-2 order-sm-2 mt-sm-5 mt-5">
							<PodcastDesc
								...
								account={props.account}
								backgroundURL={
									_podcast.hashes.backgroundHash.length > 0
										? `https://podmatic.infura-ipfs.io/ipfs/${_podcast.hashes.backgroundHash}`
										: "error"
								}
							/>
						</div>
						...
						<div className="col-sm-10 col-12 mt-lg-5 order-lg-4 mt-md-3 order-md-3 order-sm-3 mt-sm-3">
							<div className="row justify-content-center mt-5">
								<AudioPlayer
									source={`https://podmatic.infura-ipfs.io/ipfs/${_podcast.hashes.podcastAudioHash}`}
									podcastCoverURL={`https://podmatic.infura-ipfs.io/ipfs/${_podcast.hashes.imgHash}`}
									isPlaying={isPlaying}
									playPause={handlePlayPause}
									lyricsPresent={_podcast.hashes.summaryHash.length > 0 ? true : false}
								/>
							</div>
						</div>
						...
						<div className="col-lg-3 mt-lg-0 order-lg-3 mt-md-5 order-md-4 order-sm-4 mt-sm-5 mt-5">
							<div className="row justify-content-center mt-lg-0 mt-md-4 mt-sm-4 mt-4">
								<div className="col-sm-10 col-12">
									<LyricsBox
										lyricsURL={
											_podcast.hashes.summaryHash.length > 0
												? `https://podmatic.infura-ipfs.io/ipfs/${_podcast.hashes.summaryHash}`
												: "error"
										}
									/>
								</div>
