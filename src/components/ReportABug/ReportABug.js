				...
				<div className="contact_us">
					...
					<div className="row mt-4">
						<div className="offset-md-1 col-md-10 reportABug_notice">
							First, <span className="color_orange_bugsPage">thank you for reporting bugs!</span> Identifying, reproducing, and documenting bugs is
							not always fun or easy, but it’s an important part of making excellent software. It can also be rewarding, as you’ll have a direct
							influence on the platform development. We at{" "}
							<Link to={"/"} className="color_orange_bugsPage">
								Podmatic
							</Link>
					...
					<div className="row mt-4">
						<div className="offset-md-1 col-md-10 reportABug_notice">
							...
							anything that strikes you as <span className="color_orange_bugsPage">weird</span>,{" "}
							<span className="color_orange_bugsPage">unexpected</span>, or <span className="color_orange_bugsPage">broken</span> can be termed as a
							bug and is important to let us know about.
							<br />
							<br />
							<span className="color_orange_bugsPage">Report everything</span> that you find. An issue might be glaringly obvious to you, but if
							you don’t report it, we may not even know about it.
						</div>
					</div>
					...
					<div className="row mt-4">
						<div className="offset-md-1 col-md-10 reportABug_notice">
							No matter what the bug is, we will <span className="color_orange_bugsPage">always</span> want to know this information:
							<br />
							<br />
							<ul>
							...
							<span className="color_orange_bugsPage">extremely helpful</span> to us if you take the time to write it all out.{" "}
							<span className="color_orange_bugsPage">Don’t assume we know anything!</span> Perhaps you learned how to do something in another
							application, and we have a totally different way to accomplish the same thing. Simply saying that something “doesn’t work” isn’t
							very helpful; spell it out for us as simply and clearly as possible.
							<br />
							<br />
							Any supporting information you can think of adding will be appreciated. Attach anything you think might be helpful. Eg. A screenshot
							or screen recording may be the clearest way to explain your bug.
						</div>
					</div>
											...
											<div className="col-md-5">
												...
												<div className="row mt-5">
													<div className="col-md-10 col-8 provide_email">
														If you don't provide an email, we will not be able to respond to you!
													</div>
												</div>
											</div>
