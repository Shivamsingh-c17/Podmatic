		...
		if (!isMetaMaskInstalled()) {
			...
			if (buttonId === "connectButton")
				onboardButton.innerHTML =
					`<span><img src=${MetamaskFox} alt="..." height="25" class="mr-3" />` + installText + `<i class="fas fa-angle-double-right"></i></span>`;
			...
			if (buttonId === "connectButton")
				onboardButton.innerHTML =
					`<span><img src=${MetamaskFox} alt="..." height="25" class="mr-3" />` + connectText + `<i class="fas fa-angle-double-right"></i></span>`;
