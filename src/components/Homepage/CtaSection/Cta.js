...
import soundWave from "../../../assets/new-assets/audio.png";
				...
				<div className="row justify-content-center">
					...
					<div className="row cta-desc">
						<div className="col-lg-10 p-0">
							<h2>Start Creating Podcast for the new Blockchain Era</h2>
					...
					<div className="cta-card glass_effect_border">
						...
						<p className="cta-card-info">Explore a rich gallery of Digital Podcasts</p>
					</div>
				</div>
			</div>
		</div>
