				...
				<div className="contact_us">
					...
					<div className="row mt-4">
						<div className="offset-md-1 col-md-10 contact_notice">
							...
							aggregates all podcasts that users put up as NFTs and is not partnering with any of the podcasters displayed on the website. If you
							want to contact one of the podcasters listed here, you must contact them directly through other social media platforms. We are not
							responsible if someone else puts up an podcasters' podcast as an NFT on our platform and cannot assist you regarding the same.
						</div>
					</div>
